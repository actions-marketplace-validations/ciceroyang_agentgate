...
**MCP 协议版本 `2025-06-18` / `2025-03-26` / `2024-11-05` · frozen。** 这四个工具的名字、参数和
只读语义不会在小版本里改；新增工具是附加式的，删改工具名需要新版本标识加迁移说明。协议版本本身由
MCP 规范决定，我们跟随它并在这里写明支持哪几个。规则见 [compatibility.md](compatibility.md)。
